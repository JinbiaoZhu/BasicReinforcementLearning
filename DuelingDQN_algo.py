...
from discrete_policy import DiscreteVANet
...
class DuelingDQN:
    def __init__(self,
        ...
        print("DuelingQN: state_dim={}, action_dim={}, hidden_dim={}, lr={}, gamma={}, epsilon={}, target_f={}".format(
        ...
        self.DiscreteQNet = DiscreteVANet(self._state_dim, self._action_dim, self._hidden_dim).to(self._device)
        self.DiscreteQNet = init_weight(self.DiscreteQNet)

        self.target_DiscreteQNet = DiscreteVANet(self._state_dim, self._action_dim, self._hidden_dim).to(self._device)
